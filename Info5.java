...
public class Info5 extends JFrame{
    ...
    private JLabel l1,l2,l3,l4,price,dev,date;
    private Font f,f1;
    private ImageIcon trailer,buy,icon,cart,img;
    private Cursor cr;
    ...
    icon = new ImageIcon(getClass().getResource("Cyber.png"));
    l3 = new JLabel(icon);
    l3.setCursor(cr);
    l3.setBounds(850,50,200,180);   
    c.add(l3); 
    
    trailer = new ImageIcon(getClass().getResource("Cuberg.gif"));
   ...
   b4.setCursor(cr);
    ...
    l2 = new JLabel("Action role-playing");
    ...
    buy = new ImageIcon(getClass().getResource("buy.png"));
    bt1 = new JButton(buy);
    ...
    dev = new JLabel("Developer: Piotr Tomsińsk");
    ...
    date = new JLabel("Released in : December 10, 2020");
    ...
    c.add(b1);
		...
		setTitle("Diverse : Cyberpunk 2077");
    ...
    public static void main(String[] args) {
        ...
        Info5 frame = new Info5();
        frame.setVisible(true);
        frame.setDefaultCloseOperation(EXIT_ON_CLOSE);
        frame.setBounds(100,0,1100,600);
        frame.setTitle("Diverse : Cyberpunk 2077");
     }
}
