...
public class Info6 extends JFrame{
    ...
    icon = new ImageIcon(getClass().getResource("farp.png"));
    l3 = new JLabel(icon);
    l3.setCursor(cr);
    l3.setBounds(850,50,200,180);   
    c.add(l3); 
    
    trailer = new ImageIcon(getClass().getResource("farg.gif"));
   ...
   b4.setCursor(cr);
    ...
    l2 = new JLabel("Open World, Action-Adventure, Third Person Shooter");
    ...
    dev = new JLabel("Developer: Ubisoft Toronto");
    ...
    date = new JLabel("Released in : October 7, 2021");
