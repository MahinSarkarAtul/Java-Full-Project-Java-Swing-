...
public class Inf1 extends JFrame{
    ...
    icon = new ImageIcon(getClass().getResource("Apex.png"));
    l3 = new JLabel(icon);
    l3.setCursor(cr);
    l3.setBounds(850,50,200,180);   
    c.add(l3); 
    
    trailer = new ImageIcon(getClass().getResource("apex.gif"));
   ...
   b4.setCursor(cr);
    ...
    l2 = new JLabel("On PlayStation 4, PlayStation 5, Xbox One, Xbox Series X|S");
    ...
    dev = new JLabel("Developer: Respawn Entertainment");
    ...
    date = new JLabel("Released in : 2019");
