...
public class Inf6 extends JFrame{
    ...
    icon = new ImageIcon(getClass().getResource("Valorent.jpg"));
    l3 = new JLabel(icon);
    l3.setCursor(cr);
    l3.setBounds(850,50,200,180);   
    c.add(l3); 
    
    trailer = new ImageIcon(getClass().getResource("valorant.gif"));
    ...
    l2 = new JLabel("Riot Games presents VALORANT: a 5v5 character-based tactical ");
    ...
    dev = new JLabel("Developer: Rito Games");
    ...
    date = new JLabel("Released in : June 2, 2020");
