...
public class Inf2 extends JFrame{
    ...
    icon = new ImageIcon(getClass().getResource("cod.jpg"));
    l3 = new JLabel(icon);
    l3.setCursor(cr);
    l3.setBounds(850,50,200,180);   
    c.add(l3); 
    
    trailer = new ImageIcon(getClass().getResource("cod.gif"));
   ...
   b4.setCursor(cr);
    ...
    l2 = new JLabel("CRASH TEAM RUMBLE™ — COMING SOON TO XBOX AND PLAYSTATION");
    ...
    dev = new JLabel("Developer: Activision");
    ...
    date = new JLabel("Released in : 2003");
