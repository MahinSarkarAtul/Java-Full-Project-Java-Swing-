...
public class Info2 extends JFrame{
    ...
    icon = new ImageIcon(getClass().getResource("SA.png"));
    l3 = new JLabel(icon);
    l3.setCursor(cr);
    l3.setBounds(850,50,200,180);   
    c.add(l3); 
    
    trailer = new ImageIcon(getClass().getResource("San1.gif"));
   ...
   b4.setCursor(cr);
    ...
    dev = new JLabel("Developer: Rockstar Games");
    ...
    date = new JLabel("Released in : October 26, 2004");
    ...
    c.add(b1);
		...
		setTitle("Diverse : GTA San Andreas");
