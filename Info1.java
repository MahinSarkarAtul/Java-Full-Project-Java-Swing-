...
public class Info1 extends JFrame{
    ...
    icon = new ImageIcon(getClass().getResource("GTA V.png"));
    l3 = new JLabel(icon);
    l3.setCursor(cr);
    l3.setBounds(850,50,200,180);   
    c.add(l3); 
    
    trailer = new ImageIcon(getClass().getResource("Vtrailer.gif"));
   ...
   b4.setCursor(cr);
    ...
    date = new JLabel("Released in : 2013");
	...
	b1.addActionListener(new ActionListener(){
        ...
        setTitle("Diverse : Grand theft auto v");
