...
public class Inf4 extends JFrame{
    ...
    icon = new ImageIcon(getClass().getResource("Fortnite.jpg"));
    l3 = new JLabel(icon);
    l3.setCursor(cr);
    l3.setBounds(850,50,200,180);   
    c.add(l3); 
    
    trailer = new ImageIcon(getClass().getResource("fortnite.gif"));
    ...
    l2 = new JLabel("Optimized for Xbox Series X|S");
    ...
    dev = new JLabel("Developer: Epic Games");
    ...
    date = new JLabel("Released in : July 21, 2017");
