...
public class Master extends JFrame{
    ...
    public void components(){
		...
		img1= new ImageIcon(getClass().getResource("master.gif"));
		...
		user=new JLabel("Welcome to Master Card ");
		user.setBounds(120,260,270,30);
		...
		con=new JLabel("Master Card Number   :");
		con.setBounds(80,300,185,30);
        ...
        tf1 = new JTextField();
        tf1.setBounds(265,305,150,30);
        tf1.setFont(ft);
        tf1.setForeground(Color.BLACK);
        tf1.setBackground(Color.WHITE);
        tf1.setHorizontalAlignment(JTextField.CENTER);
        tf1.setToolTipText("Enter Master Card Number");
		tf1.setCursor(cr);
        c.add(tf1);
		
		wc=new JLabel("Master Card Password:");
		wc.setBounds(80,350,185,30);
        ...
        pf.setBounds(265,355,150,30);
        pf.setFont(fn);
        pf.setForeground(Color.BLACK);
        pf.setBackground(Color.WHITE);
        pf.setHorizontalAlignment(JPasswordField.CENTER);
        pf.setToolTipText("Enter Master Card Password");
		pf.setCursor(cr);
        c.add(pf);
