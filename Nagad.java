...
public class Nagad extends JFrame{
    ...
    public void components(){
		...
		img1= new ImageIcon(getClass().getResource("nagad.jpg"));
		...
		user=new JLabel("Welcome to Nagad ");
        ...
        pf.setToolTipText("Enter Nagad PIN only four digit ");
		pf.setCursor(cr);
        c.add(pf);
