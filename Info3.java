...
public class Info3 extends JFrame{
    ...
    icon = new ImageIcon(getClass().getResource("Asa.jpg"));
    l3 = new JLabel(icon);
    l3.setCursor(cr);
    l3.setBounds(850,50,200,180);   
    c.add(l3); 
    
    trailer = new ImageIcon(getClass().getResource("As.gif"));
   ...
   b4.setCursor(cr);
    ...
    date = new JLabel("Released in :November 16, 2010");
    ...
    c.add(b1);
		...
		setTitle("Diverse : Assassins Creed Brotherhood");
