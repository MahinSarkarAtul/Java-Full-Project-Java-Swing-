...
public class Inf5 extends JFrame{
    ...
    icon = new ImageIcon(getClass().getResource("Minecarft.jpg"));
    l3 = new JLabel(icon);
    l3.setCursor(cr);
    l3.setBounds(850,50,200,180);   
    c.add(l3); 
    
    trailer = new ImageIcon(getClass().getResource("minecraft.gif"));
    ...
    l2 = new JLabel("Explore new gaming adventures & merchandise on the Minecraft Official Site");
    ...
    dev = new JLabel("Developer: 4J Studio");
    ...
    date = new JLabel("Released in : November 18, 2011");
