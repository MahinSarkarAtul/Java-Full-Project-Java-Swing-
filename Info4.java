...
public class Info4 extends JFrame{
    ...
    icon = new ImageIcon(getClass().getResource("asc1.png"));
    l3 = new JLabel(icon);
    l3.setCursor(cr);
    l3.setBounds(850,50,200,180);   
    c.add(l3); 
    
    trailer = new ImageIcon(getClass().getResource("Asac.gif"));
   ...
   b4.setCursor(cr);
    ...
    l2 = new JLabel(" Action-adventure, ‎stealth");
    ...
    dev = new JLabel("Developer: Ubisoft Montreal");
    ...
    date = new JLabel("Released in : October 29, 2013");
    ...
    c.add(b1);
		...
		setTitle("Diverse : Assassins Creed Black Flag");
